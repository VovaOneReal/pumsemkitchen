<template>
  <div class="flex flex-col gap-6 w-full">
    <div class="flex gap-3 w-full items-center prose">
        <div class="btn btn-accent">Сохранить</div>
        <div class="btn">Отменить</div>
    </div>
    ...
    <div class="flex flex-col gap-6 w-full overflow-y-scroll">
        <div class="flex gap-4 w-full max-h-[300px]">
            ...
            <div class="flex w-full gap-2 flex-col prose max-w-none">
                ...
                <textarea class="textfield w-full overflow-y-scroll  h-full" name="" id="" placeholder="Описание рецепта..."></textarea>
            </div>
        </div>
