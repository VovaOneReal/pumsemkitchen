<template>
  <div
    :class="isCollapsed ? 'w-fit' : 'min-w-[20%] max-w-[20%]'"
    class="flex flex-col gap-4 bg-base-200 rounded-box pt-2"
  >
    ...
    <div class="flex flex-col justify-between h-full w-full">
      <ul class="menu w-full">
        <li>
          ...
          <div
            active-class="menu-active"
            v-else
            class="tooltip tooltip-right h-[33px] w-fit flex items-center"
            data-tip="Рецепты"
          >
            <utensils :size="16" />
          </div>
      ...
      <ul class="menu w-full">
        <li>
          <a v-if="!isCollapsed" href="" class="flex items-center"
            ><sun-moon :size="16" />Тема: ночная</a
          >
          <div
            v-else
            class="tooltip tooltip-right h-[33px] w-fit flex items-center"
            data-tip="Тема: ночная"
          >
            <sun-moon :size="16" />
          </div>
        </li>
